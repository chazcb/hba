...
def setup_images():
    filenames = {
            ...
            "OurDude": "channing-tatum.png", 
            "OurGirl": "character.png", 
            "OurDoorClosed": "door_closed.jpg", 
            "OurDoorOpen": "door_open.jpg"
            }
...
class Board(object):
    def __init__(self, width = 3, height = 3):
        ...
        for i in range(height):
            ...
            # else:
            #     row = ["Block"] + (["DoorClosed"] * inner_width) + ["Block"]
            #     game_map.append(row)
            
            #changing background to all grass
